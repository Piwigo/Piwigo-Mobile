//
//  AlbumToAlbumMigrationPolicy_0K_to_0L.swift
//  piwigoKit
//
    ...
    */
    override func createDestinationInstances(forSource sInstance: NSManagedObject,
        ...
        if let comment = sInstance.value(forKey: "comment") as? NSAttributedString {
            newAlbum.setValue(comment.string, forKey: "commentStr")
        } else {
            newAlbum.setValue("", forKey: "commentStr")
        }

        // Initialise 'commentHTML' attributed string
        newAlbum.setValue(NSAttributedString(), forKey: "commentHTML")
