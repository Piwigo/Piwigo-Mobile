...
// URLSession delegate
public let pwgSessionDelegate = PwgSessionDelegate.shared.self

// Create single session
public let dataSession: URLSession = {
    ...
    let session = URLSession(configuration: config, delegate: pwgSessionDelegate, delegateQueue: nil)
