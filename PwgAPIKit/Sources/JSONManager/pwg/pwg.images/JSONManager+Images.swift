...
public extension JSONManager {
    ...
    @concurrent
    func getInfos(forID imageId: Int64) async throws(PwgKitError) -> ImageGetInfo {
        // Prepare parameters
    ...
    @concurrent
    func deleteImages(withID imageIDs: [Int64]) async throws(PwgKitError) {
        // Prepare parameters
        let paramsDict: [String : Any] = ["image_id"  : imageIDs,
                                          "pwg_token" : ServerVars.shared.pwgToken]
