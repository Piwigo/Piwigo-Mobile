...
extension pwgImageSize {
    ...
    public var name: String {
        switch self {
        case .square:
            return String(localized: "thumbnailSizeSquare", bundle: .pwgKit,
                          comment: "Square")
        case .thumb:
            return String(localized: "thumbnailSizeThumbnail", bundle: .pwgKit,
                          comment: "Thumbnail")
        case .xxSmall:
            return String(localized: "thumbnailSizeXXSmall", bundle: .pwgKit,
                          comment: "Tiny")
        case .xSmall:
            return String(localized: "thumbnailSizeXSmall", bundle: .pwgKit,
                          comment: "Extra Small")
        case .small:
            return String(localized: "thumbnailSizeSmall", bundle: .pwgKit,
                          comment: "Small")
        case .medium:
            return String(localized: "thumbnailSizeMedium", bundle: .pwgKit,
                          comment: "Medium")
        case .large:
            return String(localized: "thumbnailSizeLarge", bundle: .pwgKit,
                          comment: "Large")
        case .xLarge:
            return String(localized: "thumbnailSizeXLarge", bundle: .pwgKit,
                          comment: "Extra Large")
        case .xxLarge:
            return String(localized: "thumbnailSizeXXLarge", bundle: .pwgKit,
                          comment: "Huge")
        case .xxxLarge:
            return String(localized: "thumbnailSizeXXXLarge", bundle: .pwgKit,
                          comment: "Extra Huge")
        case .xxxxLarge:
