...
extension pwgPrivacy {
    ...
    public var name: String {
        switch self {
        case .everybody:
            return String(localized: "privacyLevel_everybody", bundle: .pwgKit,
                          comment: "Everybody")
        case .adminsFamilyFriendsContacts:
            return String(localized: "privacyLevel_adminsFamilyFriendsContacts", bundle: .pwgKit,
                          comment: "Admins, Family, Friends, Contacts")
        case .adminsFamilyFriends:
            return String(localized: "privacyLevel_adminsFamilyFriends", bundle: .pwgKit,
                          comment: "Admins, Family, Friends")
        case .adminsFamily:
            return String(localized: "privacyLevel_adminFamily", bundle: .pwgKit,
                          comment: "Admins, Family")
        case .admins:
            return String(localized: "privacyLevel_admin", bundle: .pwgKit,
                          comment: "Admins")
        default:
            return ""
        }
