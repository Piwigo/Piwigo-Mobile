...
public struct RenameAction: Hashable {
    ...
    public enum ActionType: Int, CaseIterable, Comparable, Sendable {
        ...
        public var name: String {
            switch self {
            case .addText:
                return String(localized: "Text", bundle: .pwgCacheKit,
                              comment: "Text")
            case .addAlbum:
                return String(localized: "albumID", bundle: .pwgCacheKit,
                              comment: "Album ID")
            case .addDate:
                return String(localized: "editImageDetails_dateCreation", bundle: .pwgCacheKit,
                              comment: "Creation Date")
            case .addTime:
                return String(localized: "editImageDetails_timeCreation", bundle: .pwgCacheKit,
                              comment: "Creation Time")
            case .addCounter:
                return String(localized: "Counter", bundle: .pwgCacheKit,
                              comment: "Counter")
            }
        }
