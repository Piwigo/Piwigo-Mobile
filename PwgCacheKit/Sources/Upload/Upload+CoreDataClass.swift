...
extension Upload {
    ...
    public func getProperties() -> UploadProperties {
        ...
        return UploadProperties(
            ...
            // Server parameters
            serverPath: self.user?.server?.path ?? ServerVars.shared.serverPath,
            serverFileTypes: self.user?.server?.fileTypes ?? ServerVars.shared.serverFileTypes,
...
extension SectionKeys {
    ...
    public var name: String {
        switch self {
        case .Section1:
            return String(localized: "uploadSection_impossible", bundle: .pwgCacheKit,
                          comment: "Impossible Uploads")
        case .Section2:
            return String(localized: "uploadSection_resumable", bundle: .pwgCacheKit,
                          comment: "Resumable Uploads")
        case .Section3:
            return String(localized: "uploadSection_queue", bundle: .pwgCacheKit,
...
extension pwgUploadState {
    ...
    public var stateInfo: String {
        switch self {
        case .waiting:
            return String(localized: "imageUploadTableCell_waiting", bundle: .pwgCacheKit, comment: "Waiting...")
        case .preparing:
        ...
        case .formatError:
            return String(localized: "imageUploadError_format", bundle: .pwgCacheKit, comment: "File format not accepted by Piwigo server.")
