...
enum DataMigrationVersion: String, CaseIterable {
    ...
    case version08 = "DataModel 08 (Upload)"                    // from v2.7    on 12 August 2021 (moved to PwgKit)
    ...
    case version0N = "DataModel 0N (Sizes)"                     // from v4.1.3  on 14 December 2025
    case version0O = "DataModel 0O (Upload.assetToDelete)"      // from v4.3    on 26 July 2026
    case version0P = "DataModel 0P (User+Album+Image+Upload)"   // from v4.4    on 16 August 2026
