...
final class TagToTagMigrationPolicy_09_to_0C: NSEntityMigrationPolicy {
    ...
    override func begin(_ mapping: NSEntityMapping, with manager: NSMigrationManager) throws {
        ...
        guard let _ = URL(string: ServerVars.shared.serverPath) else {  return }
        ...
        newServer.setValue(ServerVars.shared.serverPath, forKey: "path")
        newServer.setValue(ServerVars.shared.serverFileTypes, forKey: "fileTypes")

        // Store new server instance in userInfo for reuse
        manager.userInfo = [ServerVars.shared.serverPath : newServer]
    ...
    */
    override func createDestinationInstances(forSource sInstance: NSManagedObject,
        ...
        guard var userInfo = manager.userInfo,
              let newServer = userInfo[ServerVars.shared.serverPath] as? NSManagedObject else { return }
