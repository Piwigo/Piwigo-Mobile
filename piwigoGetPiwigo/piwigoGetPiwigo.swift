//
//  piwigoGetPiwigo.swift
//  piwigoGetPiwigo
//
//  Created by Eddy Lelièvre-Berna on 27/08/2018.
...
class piwigoGetPiwigo: XCTestCase {
    ...
    func testScreenshot() {
        ...
        // Screenshot
        if deviceType.hasPrefix("iPhone") {
            // Swipe left and reveal album actions
            let collectionCell = app.collectionViews.children(matching: .cell).element(boundBy: 1)
