...
//            }
    ...
    func setImageParameters(for upload: Upload) {
        UploadManager.logger.notice("\(upload.objectID.uriRepresentation().absoluteString) • setImageParameters()")
    ...
    func emptyLounge(for upload: Upload) {
        UploadManager.logger.notice("\(upload.objectID.uriRepresentation().absoluteString) • Empty lounge")
