...
//                upload.setState(.finishingError, error: .networkUnavailable)
//            })
...
//                    upload.setState(.uploadingError, error: .networkUnavailable)
//                    findNextImageToUpload()
//                }
//            }
//            return
...
//                upload.setState(.preparingError, error: .missingAsset)
//            }
//            uploadBckgContext.saveIfNeeded()
//            findNextImageToUpload()
//            return
...
//                await launchTransfer(of: prepared)
//            }
//            return
//        }
//        
...
//            await appendAutoUploadRequests()
//        }
//        
...
//                        UploadManager.logger.notice("\(objectURI.lastPathComponent) • Foreground task \(task.taskIdentifier, privacy: .public) is uploading")
...
//                            
//                            // Remembers that this upload request is being dealt with
//                            UploadManager.logger.notice("\(objectURI.lastPathComponent) • Background task \(task.taskIdentifier, privacy: .public) is uploading")
...
//                        // Launch transfer
//                        await launchTransfer(of: upload)
//                    }
//                }
//            }
//        }
