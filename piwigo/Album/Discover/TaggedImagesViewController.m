...
-(void)addImageToFavorites
{
    ...
    // Get image data
    PiwigoImageData *imageData = [[CategoriesData sharedInstance] getImageForCategory:kPiwigoTagsCategoryId andId:[[self.selectedImageIds lastObject] integerValue]];
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.albumData.images.count > indexPath.item) {
        ...
        [cell setupWithImageData:imageData inCategoryId:kPiwigoTagsCategoryId forSize:self.imageCellSize];
    ...
    if (![[[CategoriesData sharedInstance] getCategoryById:kPiwigoTagsCategoryId] hasAllImagesInCache]) {
