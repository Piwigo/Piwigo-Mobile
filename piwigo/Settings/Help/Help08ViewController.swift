...
class Help08ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Set top image view
        guard let topImageUrl = Bundle.main.url(forResource: "help08-top", withExtension: "png")
        else { preconditionFailure("!!! Could not find help08-top image !!!") }
        ...
        guard let botImageUrl = Bundle.main.url(forResource: "help08-bot", withExtension: "png")
        else { preconditionFailure("!!! Could not find help08-bot image !!!") }
