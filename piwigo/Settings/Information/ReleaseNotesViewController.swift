...
final class ReleaseNotesViewController: UIViewController {
    ...
    private func notesAttributedString() -> NSMutableAttributedString? {
        ...
        notesAttributedString.append(releaseNotes("v4.4.2_text", comment: "v4.4.2 Release Notes text"))
        ...
        notesAttributedString.append(releaseNotes("v4.3.1_text", comment: "v4.3.1 Release Notes text"))
        ...
        notesAttributedString.append(releaseNotes("v4.2.1_text", comment: "v4.2.1 Release Notes text"))
        ...
        notesAttributedString.append(releaseNotes("v4.1.1_text", comment: "v4.1.1 Release Notes text"))
        notesAttributedString.append(releaseNotes("v4.1.0_text", comment: "v4.1.0 Release Notes text"))
