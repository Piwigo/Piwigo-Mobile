...
@interface TaggedImagesViewController () <UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate, ImageDetailDelegate, EditImageParamsDelegate, ShareImageActivityItemProviderDelegate, MoveImagesDelegate>
...
-(void)addImagesToCategory
{
    ...
    MoveImageViewController *moveImageVC = [[MoveImageViewController alloc] initWithSelectedImageIds:self.selectedImageIds orSingleImageData:firstImageData inCategoryId:kPiwigoTagsCategoryId atIndex:indexOfFirstSelectedImage andCopyOption:YES];
