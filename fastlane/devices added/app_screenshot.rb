...
module Deliver
  ...
  class AppScreenshot
    ...
    module ScreenSize
      ...
      # iPhone XS
      IOS_58 = "iOS-5.8-in"
      # iPhone 17 Pro, iPhone 17, iPhone 16 Pro, iPhone 16, iPhone 15 Pro, iPhone 15, iPhone 14 Pro
      IOS_61 = "iOS-6.1-in"
      # iPhone 14 Plus, iPhone 13 Pro Max, iPhone 12 Pro Max, iPhone 11 Pro Max, iPhone 11, iPhone XS Max, iPhone XR
      IOS_65 = "iOS-6.5-in"
      # iPhone Air, iPhone 17 Pro Max, iPhone 16 Plus, iPhone 16 Plus, iPhone 15 Pro Max, iPhone 15 Plus, iPhone 14 Pro Max
      IOS_67 = "iOS-6.7-in"
    ...
    def self.devices
      ...
      return {
        ...
        ScreenSize::IOS_IPAD_11 => [ # 11 inch
          [1668, 2388],
          [1668, 2420],
          [2388, 1668],
          [2420, 1668]
        ],
        ScreenSize::IOS_IPAD_PRO => [ # 12.9 inch
          [2732, 2048],
          [2048, 2732]
        ],
        ScreenSize::IOS_IPAD_PRO_12_9 => [ # 13 inch
          [2752, 2064],
          [2064, 2752]
        ],
        ScreenSize::MAC => [
